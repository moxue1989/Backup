...
<script type="text/javascript">
	$(document).ready(function() {
		$('#CustCountry').change(function(event) {
			var selection = $(this).val();
			if (selection != "") {				
				$.get('ProvState', {data: selection}, function(response) {
					//alert(response);
					$('#CustProv').html(response);					
				}); 	
			} else {
				$('#CustProv').html("<option value=''>Select A Country First</option>");
			}
...
<%!
   public String createCustomer(String [] customerArray)
		...
		public void displayForm(String [] customerArray, JspWriter out) throws IOException
		{
			...
			out.print("<option value=''>Select A Country First</option>");
/*			out.print("<option value='AB'>AB</option>");
			...
			out.print("<option value='2'>Canada</option>");
			out.print("<option value='1'>United States</option>");
			out.print("</select>");
			out.print("</div>");
			out.print("</td>");
			out.print("</tr>");
