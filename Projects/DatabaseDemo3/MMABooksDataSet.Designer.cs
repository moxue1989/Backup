...
SELECT CustomerID, Name, Address, City, State, ZipCode FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        public virtual int FillBy(MMABooksDataSet.CustomersDataTable dataTable, int CustomerID) {
    ...
    public partial class InvoicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Invoices] WHERE (([InvoiceID] = @Original_InvoiceID) AND ([CustomerI" +
                "D] = @Original_CustomerID) AND ([InvoiceDate] = @Original_InvoiceDate) AND ([Inv" +
                "oiceTotal] = @Original_InvoiceTotal))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT InvoiceID, CustomerID, InvoiceDate, ProductTotal, SalesTax, Shipping, InvoiceTotal FROM Invoices WHERE (InvoiceID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Invoices] SET [CustomerID] = @CustomerID, [InvoiceDate] = @InvoiceDate, [InvoiceTotal] = @InvoiceTotal WHERE (([InvoiceID] = @Original_InvoiceID) AND ([CustomerID] = @Original_CustomerID) AND ([InvoiceDate] = @Original_InvoiceDate) AND ([InvoiceTotal] = @Original_InvoiceTotal));
SELECT InvoiceID, CustomerID, InvoiceDate, InvoiceTotal FROM Invoices WHERE (InvoiceID = @InvoiceID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT InvoiceID, CustomerID, InvoiceDate, InvoiceTotal FROM Invoices";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
